...
@InputType()
class SurveyResponseUpdateManyWithoutSurveyLinksInput {
...
export { SurveyResponseUpdateManyWithoutSurveyLinksInput as SurveyResponseUpdateManyWithoutSurveyLinksInput };
